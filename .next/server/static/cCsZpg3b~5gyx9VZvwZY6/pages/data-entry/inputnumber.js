...
/******/ 	return __webpack_require__(__webpack_require__.s = "d231");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = __webpack_require__("jAXQ");
...
// CONCATENATED MODULE: ./demos/antd/input-number/basic.js
...
var basic_Component = function Component() {
  return external_react_default.a.createElement(external_antd_["InputNumber"], {
    min: 1,
    max: 10,
    defaultValue: 3,
    onChange: onChange
...
// CONCATENATED MODULE: ./demos/antd/input-number/digit.js



function digit_onChange(value) {
  console.log('changed', value);
}

var digit_Component = function Component() {
  return external_react_default.a.createElement(external_antd_["InputNumber"], {
    min: 0,
    max: 10,
    step: 0.1,
    onChange: digit_onChange
  });
};

/* harmony default export */ var digit = (digit_Component);
// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/helpers/esm/assertThisInitialized.js
var assertThisInitialized = __webpack_require__("AT/M");
...
// CONCATENATED MODULE: ./demos/antd/input-number/disabled.js
...
function (_React$Component) {
  ...
  Object(createClass["a" /* default */])(App, [{
    ...
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(external_antd_["InputNumber"], {
        min: 1,
        max: 10,
...
/* harmony default export */ var disabled = (disabled_App);
// CONCATENATED MODULE: ./demos/antd/input-number/formatter.js



function formatter_onChange(value) {
  console.log('changed', value);
}

var formatter_Component = function Component() {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(external_antd_["InputNumber"], {
    defaultValue: 1000,
...
/* harmony default export */ var formatter = (formatter_Component);
// CONCATENATED MODULE: ./demos/antd/input-number/size.js
...
// CONCATENATED MODULE: ./demos/antd/input-number/demo.js
  ...
  Object(createClass["a" /* default */])(Demo, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_antd_["Card"], {
        ...
        orientation: "left"
      }, external_react_default.a.createElement("small", null, "Digit")), external_react_default.a.createElement("div", {
        className: "p-4"
      }, external_react_default.a.createElement(digit, null)), external_react_default.a.createElement(external_antd_["Divider"], {
        orientation: "left"
        ...
        orientation: "left"
      }, external_react_default.a.createElement("small", null, "Formatter")), external_react_default.a.createElement("div", {
        className: "p-4"
      }, external_react_default.a.createElement(formatter, null)), external_react_default.a.createElement(external_antd_["Divider"], {
        orientation: "left"
...
// CONCATENATED MODULE: ./pages/data-entry/inputnumber.js



var inputnumber_DemoPage = function DemoPage() {
  return external_react_default.a.createElement(demo, null);
};

/* harmony default export */ var inputnumber = __webpack_exports__["default"] = (inputnumber_DemoPage);
