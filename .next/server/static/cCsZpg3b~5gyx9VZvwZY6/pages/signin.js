...
var Signin_Signin = function Signin(_ref) {
  ...
  return external_react_default.a.createElement(external_antd_["Row"], {
    ...
    className: "mb-0 mt-3"
  }, "Sign in"), external_react_default.a.createElement("p", {
    className: "text-muted"
  }, "get started with our service")), external_react_default.a.createElement(external_antd_["Form"], {
    layout: "vertical",
    onSubmit: function onSubmit(e) {
      e.preventDefault();
      form.validateFields(function (err, values) {
        if (!err) {
          external_antd_["Message"].success('Sign complete. Taking you to your dashboard!').then(function () {
    ...
    prefix: external_react_default.a.createElement(external_react_feather_["Eye"], {
      size: 16,
      strokeWidth: 1,
      style: {
        color: 'rgba(0,0,0,.25)'
  ...
  }))), external_react_default.a.createElement(FormItem, null, form.getFieldDecorator('remember', {
    valuePropName: 'checked',
    initialValue: true
  })(external_react_default.a.createElement(external_antd_["Checkbox"], null, "Remember me")), external_react_default.a.createElement(link_default.a, {
    href: "/forgot"
  }, external_react_default.a.createElement("a", {
    className: "text-xs-right"
  }, external_react_default.a.createElement("small", null, "Forgot password"))), external_react_default.a.createElement(external_antd_["Button"], {
    type: "primary",
    htmlType: "submit",
    block: true,
    className: "mt-3"
  }, "Log in")), external_react_default.a.createElement("div", {
...
/* harmony default export */ var components_Signin = (external_antd_["Form"].create()(Signin_Signin));
// CONCATENATED MODULE: ./pages/signin.js



var signin_SigninPage = function SigninPage() {
  return external_react_default.a.createElement(components_Signin, null);
};
