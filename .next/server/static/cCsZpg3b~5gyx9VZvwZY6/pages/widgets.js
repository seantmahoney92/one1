...
var StyledCard = external_styled_components_default.a.div(_templateObject());
var Cover = external_styled_components_default.a.div(_templateObject2());

var ImageStatCard_ImageStatCard = function ImageStatCard(_ref) {
  var images = _ref.images,
      imageHeight = _ref.imageHeight,
      stats = _ref.stats;
  return external_react_default.a.createElement(StyledCard, null, external_react_default.a.createElement(external_antd_["Card"], {
    className: "mb-4",
  ...
  return external_react_default.a.createElement(external_antd_["Card"], {
    ...
    renderItem: function renderItem(item) {
      return external_react_default.a.createElement(external_antd_["List"].Item, {
        ...
        avatar: item.avatar ? item.avatar : external_react_default.a.createElement(external_antd_["Avatar"], {
          size: 48,
          style: {
            color: 'rgb(143, 0, 245)',
...
function ProfileCard_templateObject2() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n  position: relative;\n  .message,\n  .phone {\n    position: absolute;\n    top: 60%;\n    margin-top: -8px;\n    z-index: 1;\n  }\n  .message {\n    left: -8px;\n  }\n  .phone {\n    right: -8px;\n  }\n"]);

  ProfileCard_templateObject2 = function _templateObject2() {
    return data;
  };
...
function ProfileCard_templateObject() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n  position: relative;\n  width: 100%;\n  .ant-carousel {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n  }\n  .slick-slider {\n    width: 100%;\n    height: 100%;\n  }\n  .slick-slide > div {\n    display: flex;\n  }\n  .image {\n    position: relative;\n    background-size: cover;\n    background-position: top center;\n    width: 100%;\n  }\n  .weakColor & .image {\n    -webkit-filter: invert(100%);\n    filter: invert(100%);\n  }\n  .content {\n    position: relative;\n    z-index: 9;\n  }\n"]);

  ProfileCard_templateObject = function _templateObject() {
    return data;
  };
...
var ProfileCard_Cover = external_styled_components_default.a.div(ProfileCard_templateObject());
var Picture = external_styled_components_default.a.div(ProfileCard_templateObject2());
...
var ProfileCard_ProfileCard = function ProfileCard(_ref) {
  ...
  return external_react_default.a.createElement(external_antd_["Card"], {
    ...
    cover: external_react_default.a.createElement(ProfileCard_Cover, {
      ...
      justify: "space-around",
      className: "mb-4"
    }, external_react_default.a.createElement(Picture, null, external_react_default.a.createElement(external_antd_["Button"], {
      shape: "circle",
      type: "primary",
      size: "large",
      ...
      onClick: callHandler,
      className: "phone"
    }, external_react_default.a.createElement(external_react_feather_["PhoneCall"], {
      size: 16,
      strokeWidth: 1
    })))), external_react_default.a.createElement("h5", {
      className: "mb-0 text-white"
...
var Widgets_Widgets = function Widgets() {
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_antd_["Row"], {
    ...
    clickHandler: function clickHandler() {
      return external_antd_["Message"].info('Customer stat button clicked');
    }
  })), external_react_default.a.createElement(external_antd_["Col"], {
    xs: 24,
    sm: 12,
    ...
    callHandler: function callHandler() {
      return external_antd_["Message"].info('Call button clicked');
    },
    messageHandler: function messageHandler() {
      return external_antd_["Message"].info('Message button clicked');
    }
  }))), external_react_default.a.createElement(external_antd_["Row"], {
    gutter: 16
  }, external_react_default.a.createElement(external_antd_["Col"], {
